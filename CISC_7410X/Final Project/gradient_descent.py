...
# From WhatsApp: implement a generic gradient descent function in any other programming language that you can pass in a line, curve, and plane. That can take dataset and any equation and find the best fit theta. And it should take hyper-parameters and have some flexible method for sealing with hyperparams
...
# I couldn't ever find what was under the hood of Malt's "gradient-of" function, so I decided to use the central difference approximation: https://en.wikipedia.org/wiki/Finite_difference
...
# In general, I was surprised by how few resources are out there for unflattening a list via its original structure - could be a good opp. for a library
